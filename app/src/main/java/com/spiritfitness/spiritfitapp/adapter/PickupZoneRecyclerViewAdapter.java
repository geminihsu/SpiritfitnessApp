...
public class PickupZoneRecyclerViewAdapter extends RecyclerView.Adapter<PickupZoneRecyclerViewAdapter.NormalTextViewHolder> {

    private final Context mContext;
    private List<PickUpZoneMap> mTitles;

    public PickupZoneRecyclerViewAdapter(Context context, List<PickUpZoneMap> _mTitles) {
        mTitles = _mTitles;
        mContext = context;
